...
with st.expander("⚙️ Cấu hình API và các tham số", expanded=False):
    ...
    with col1:
        ...
        API_URL = st.text_input("API URL", value=st.session_state.get("api_url", "https://site1.com"), key="thfc_api_url_input")
        EVALUATE_API_URL = st.text_input("Evaluate API URL", value=st.session_state.get("evaluate_api_url", "https://site2.com"), key="thfc_evaluate_api_url_input")
...
with tab2:
    ...
    if existing_job:
        ...
        schedule_api_url = st.text_input("API URL cho lịch test", st.session_state.get("schedule_api_url", "https://site1.com"), key="thfc_schedule_api_url_input")
        schedule_evaluate_api_url = st.text_input("Evaluate API URL cho lịch test", st.session_state.get("schedule_evaluate_api_url", "https://site2.com"), key="thfc_schedule_evaluate_api_url_input")
        ...
        test_name = st.text_input("Tên bộ test (để nhận diện trong lịch sử)", key="thfc_test_name_input")
        ...
        if test_name:
            ...
            with col1:
                if schedule_type == "minute":
                    ...
                    schedule_time_input = st.time_input("Thời gian", key="thfc_schedule_time_input")
